...
export default function ToolsCatalog(props) {
    ...
    return (
        <div className="toolsCatalog">
            ...
            <BasicSelectD search="category" searchPublications={props.searchPublications} url='https://system-rentail-api.herokuapp.com/categories' title='Categoría'/>
            ...
            <BasicSelectM search="category" searchPublications={props.searchPublications} url='https://system-rentail-api.herokuapp.com/categories' title='Categoría'/>
